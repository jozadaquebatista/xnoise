...
//        ms.url_loaded.disconnect(on_url_loaded);
    ...
    private void on_selection_changed(MediaSoureWidget sender, string dname) {
        if(dname == MAGNATUNE_MUSIC_STORE_NAME) {
//            if(ms == null) {
//                ms = new UStore();
//                //Signals
...
//        ms = null;
    ...
    private const Gtk.ActionEntry[] action_entries = {
        { "ViewMenuAction", null, N_("_View") },
            { "ShowMagnatuneStore", "ubuntuone", N_("Show Magnatune Store"), null, N_("Show Magnatune Store"), on_show_store_menu_clicked}
    };
