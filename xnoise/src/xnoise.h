/* xnoise.h generated by valac 0.10.0, the Vala compiler, do not modify */
...
void xnoise_media_browser_model_insert_stream (XnoiseMediaBrowserModel* self, XnoiseTrackData* tda);
void xnoise_media_browser_model_insert_file (XnoiseMediaBrowserModel* self, XnoiseTrackData* tda);
