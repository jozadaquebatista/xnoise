/* libplaylist.h generated by valac 0.11.5, the Vala compiler, do not modify */
...
gboolean pl_is_known_playlist_extension (gchar** ext);
gchar* pl_get_extension (GFile* f);
...
void pl_item_add_field (PlItem* self, PlItemField field, const gchar* val);
PlItemField* pl_item_get_contained_fields (PlItem* self, int* result_length1);
gchar* pl_item_get_field (PlItem* self, PlItemField field);
gchar* pl_item_get_uri (PlItem* self);
gchar* pl_item_get_rel_path (PlItem* self);
gchar* pl_item_get_abs_path (PlItem* self);
gchar* pl_item_get_title (PlItem* self);
gchar* pl_item_get_author (PlItem* self);
gchar* pl_item_get_genre (PlItem* self);
gchar* pl_item_get_album (PlItem* self);
gchar* pl_item_get_copyright (PlItem* self);
gchar* pl_item_get_duration_string (PlItem* self);
gchar* pl_item_get_param_name (PlItem* self);
gchar* pl_item_get_param_value (PlItem* self);
...
const gchar* pl_item_get_base_path (PlItem* self);
void pl_item_set_base_path (PlItem* self, const gchar* value);
...
void pl_item_collection_add_general_info (PlItemCollection* self, const gchar* key, const gchar* val);
gchar** pl_item_collection_get_general_info_keys (PlItemCollection* self, int* result_length1);
gchar* pl_item_collection_get_general_info (PlItemCollection* self, const gchar* key);
gboolean pl_item_collection_data_available (PlItemCollection* self);
gchar** pl_item_collection_get_found_uris (PlItemCollection* self, int* result_length1);
gchar* pl_item_collection_get_title_for_uri (PlItemCollection* self, gchar** uri_needle);
gchar* pl_item_collection_get_author_for_uri (PlItemCollection* self, gchar** uri_needle);
gchar* pl_item_collection_get_genre_for_uri (PlItemCollection* self, gchar** uri_needle);
gchar* pl_item_collection_get_album_for_uri (PlItemCollection* self, gchar** uri_needle);
gchar* pl_item_collection_get_copyright_for_uri (PlItemCollection* self, gchar** uri_needle);
gchar* pl_item_collection_get_duration_string_for_uri (PlItemCollection* self, gchar** uri_needle);
glong pl_item_collection_get_duration_for_uri (PlItemCollection* self, gchar** uri_needle);
gchar* pl_item_collection_get_param_name_for_uri (PlItemCollection* self, gchar** uri_needle);
gchar* pl_item_collection_get_param_value_for_uri (PlItemCollection* self, gchar** uri_needle);
gboolean pl_item_collection_get_is_remote_for_uri (PlItemCollection* self, gchar** uri_needle);
gboolean pl_item_collection_get_is_playlist_for_uri (PlItemCollection* self, gchar** uri_needle);
...
gboolean pl_item_collection_contains_field (PlItemCollection* self, PlItemField field, const gchar* value);
PlItemField* pl_item_collection_get_contained_fields_for_idx (PlItemCollection* self, gint idx, int* result_length1);
PlItemField* pl_item_collection_get_contained_fields_for_uri (PlItemCollection* self, gchar** uri, int* result_length1);
...
PlResult pl_reader_read (PlReader* self, const gchar* list_uri, GCancellable* cancellable, GError** error);
void pl_reader_read_asyn (PlReader* self, const gchar* list_uri, GCancellable* cancellable, GAsyncReadyCallback _callback_, gpointer _user_data_);
...
gchar** pl_reader_get_found_uris (PlReader* self, int* result_length1);
gchar* pl_reader_get_title_for_uri (PlReader* self, gchar** uri_needle);
gchar* pl_reader_get_author_for_uri (PlReader* self, gchar** uri_needle);
gchar* pl_reader_get_genre_for_uri (PlReader* self, gchar** uri_needle);
gchar* pl_reader_get_album_for_uri (PlReader* self, gchar** uri_needle);
gchar* pl_reader_get_copyright_for_uri (PlReader* self, gchar** uri_needle);
gchar* pl_reader_get_duration_string_for_uri (PlReader* self, gchar** uri_needle);
glong pl_reader_get_duration_for_uri (PlReader* self, gchar** uri_needle);
gboolean pl_reader_get_is_remote_for_uri (PlReader* self, gchar** uri_needle);
gboolean pl_reader_get_is_playlist_for_uri (PlReader* self, gchar** uri_needle);
PlListType pl_reader_get_ptype (PlReader* self);
const gchar* pl_reader_get_playlist_uri (PlReader* self);
PlItemCollection* pl_reader_get_data_collection (PlReader* self);
PlListType pl_get_playlist_type_for_uri (gchar** uri_);
PlListType pl_get_type_by_extension (gchar** uri_);
PlListType pl_get_type_by_data (gchar** uri_);
glong pl_get_duration_from_string (gchar** duration_string);
GFile* pl_get_file_for_location (const gchar* adr, gchar** base_path, PlTargetType* tt);
...
PlResult pl_writer_write (PlWriter* self, PlItemCollection* data_collection, const gchar* playlist_uri, GCancellable* cancellable, GError** error);
void pl_writer_write_asyn (PlWriter* self, PlItemCollection* data_collection, const gchar* playlist_uri, GCancellable* cancellable, GAsyncReadyCallback _callback_, gpointer _user_data_);
PlResult pl_writer_write_asyn_finish (PlWriter* self, GAsyncResult* _res_, GError** error);
const gchar* pl_writer_get_uri (PlWriter* self);
...
SimpleXmlReader* simple_xml_reader_new_from_string (const gchar* xml_string);
SimpleXmlReader* simple_xml_reader_construct_from_string (GType object_type, const gchar* xml_string);
...
SimpleXmlWriter* simple_xml_writer_new (SimpleXmlNode* root, const gchar* header_string);
SimpleXmlWriter* simple_xml_writer_construct (GType object_type, SimpleXmlNode* root, const gchar* header_string);
void simple_xml_writer_write (SimpleXmlWriter* self, const gchar* filename);
...
SimpleXmlNode* simple_xml_node_new (const gchar* name);
SimpleXmlNode* simple_xml_node_construct (GType object_type, const gchar* name);
...
SimpleXmlNode* simple_xml_node_get_child_by_name (SimpleXmlNode* self, const gchar* childname);
SimpleXmlNode** simple_xml_node_get_children_by_name (SimpleXmlNode* self, const gchar* childname, int* result_length1);
...
const gchar* simple_xml_node_get_text (SimpleXmlNode* self);
void simple_xml_node_set_text (SimpleXmlNode* self, const gchar* value);
const gchar* simple_xml_node_get_name (SimpleXmlNode* self);
...
void simple_xml_node_attributes_add (SimpleXmlNodeAttributes* self, const gchar* key, const gchar* val);
void simple_xml_node_attributes_replace (SimpleXmlNodeAttributes* self, const gchar* key, const gchar* val);
void simple_xml_node_attributes_remove (SimpleXmlNodeAttributes* self, const gchar* key);
void simple_xml_node_attributes_clear (SimpleXmlNodeAttributes* self);
gchar* simple_xml_node_attributes_get (SimpleXmlNodeAttributes* self, const gchar* key);
void simple_xml_node_attributes_set (SimpleXmlNodeAttributes* self, const gchar* key, const gchar* val);
...
gboolean simple_xml_node_attributes_keys_contains (SimpleXmlNodeAttributesKeys* self, const gchar* needle_key);
...
gchar* simple_xml_node_attributes_keys_iterator_get (SimpleXmlNodeAttributesKeysIterator* self);
...
extern const gchar* PL_known_playlist_extensions[5];
extern const gchar* PL_remote_schemes[2];
