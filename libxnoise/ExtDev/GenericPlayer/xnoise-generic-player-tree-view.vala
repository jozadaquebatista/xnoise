...
//    };
//    
//    internal GenericPlayerTreeStore treemodel;
//    
//    
//    public GenericPlayerTreeView(GenericPlayerDevice audio_player_device,
//                                 Cancellable cancellable) {
//        this.audio_player_device = audio_player_device;
//        this.cancellable = cancellable;
//        File[] dirs = {};
//        foreach(string fd in audio_player_device.player_folders) {
//            var f = File.new_for_uri(fd);
//            dirs += f;
//        }
//        treemodel = new GenericPlayerTreeStore(this, audio_player_device, dirs, cancellable);
//        setup_view();
...
//            return false;
//        if(!(this.audio_player_device is PlayerDevice))
//            return false;
//        
//        string[] destinations = {};
//        
...
//                //print("done copying file to player device.\n");
//            }
//        }
//        
//        Timeout.add(200, () => {
