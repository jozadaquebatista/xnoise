/* xnoise-audio-item-handler.vala
 *
...
private abstract class Xnoise.HandlerPlayerDevice : ItemHandler {
    private Action a;
    private Action c;
    ...
    protected abstract unowned string get_add_info();
    protected abstract unowned string get_add_name();
    protected abstract unowned string get_del_info();
    protected abstract unowned string get_del_name();
