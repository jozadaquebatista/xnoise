...
private class Xnoise.PlaylistTreeViewMostplayed : Gtk.TreeView, Xnoise.PlaylistQueryable {
    ...
    public PlaylistTreeViewMostplayed(DockableMedia dock, MainWindow window, Widget ow) {
        ...
        column.add_attribute(renderer, "itype"  , MostplayedTreeviewModel.Column.ITEMTYPE);
        column.add_attribute(renderer, "text", MostplayedTreeviewModel.Column.VIS_TEXT);
        column.add_attribute(renderer, "pix" , MostplayedTreeviewModel.Column.ICON);
