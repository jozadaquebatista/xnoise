/* xnoise-dockable-playlist-lastplayed.vala
 *
...
private class Xnoise.DockablePlaylistLastplayed : DockableMedia {
    ...
    public override Gtk.Widget? get_widget(MainWindow window) {
        ...
        var tv = new PlaylistTreeViewLastplayed(window, (Widget)sw);
